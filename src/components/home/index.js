  ...
  return (
    <section className={`w-full ${styles.container}`}>
      <article className="flex flex-col justify-center items-center h-full">
        ...
        <div className={`space-x-10 mt-24 ${styles.icons}`}>
          <a
      ...
      <img
        ...
        src="image/Ellipse-left-top.svg"
        alt="Ellipse"
      />
      <img
        className={styles.ellipse2}
        src="image/Ellipse-right-top.svg"
        alt="Ellipse"
      />
      <img
        className={styles.ellipse3}
        src="image/Ellipse-left-bottom.svg"
        alt="Ellipse"
      />
      <img
        className={styles.ellipse4}
        src="image/Ellipse-right-bottom.svg"
        alt="Ellipse"
      />
      <img
